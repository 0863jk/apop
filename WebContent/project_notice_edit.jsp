...
<%
	...
	int iNoticeId = Integer.parseInt(strNoticeId);
	List noticeList = notice.selectView(_pid, strNoticeId);
%>
	<div class="row">
		<!-- 사이드바 -->
...
%>
			<div class="form-group">
				<input type="email" class="form-control" id="title" value="<%=vo.getTitle()%>">
			</div>
			<div class="form-group">
				<textarea class="form-control" rows="10"><%=vo.getContent() %></textarea>
			</div>
<%
}
%>
