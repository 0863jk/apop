	...
	<div class="row">
		...
		<div class="col-sm-2">	</div>
			<div class="col-sm-10 ml-auto py-auto">
				...
				<h3 class="text-center">멤버 목록</h3><hr>
					<div class="container">
					<div class="row">
						<div>
							<div style="display: flex; justify-content: right;">
								<p>
									<button class="pull-right btn btn-primary" onclick="showPopup();">멤버 추가</button>
									<a href="project_member_list.jsp" class="pull-right btn btn-primary">목록으로</a>
								</p>
							</div>
						</div>
					</div>
						<div class="row">
							<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
								<thead>
									<tr>
										<th style="background-color: #eeeeee; text-align: center;" width="15%">이름</th>
										<th style="background-color: #eeeeee; text-align: center;" width="30%">핸드폰</th>
										<th style="background-color: #eeeeee; text-align: center;" width="30%">메일</th>
										<th style="background-color: #eeeeee; text-align: center;" width="20%">소속</th>
										<th style="background-color: #eeeeee; text-align: center;" width="5%"></th>
									</tr>
								</thead>
								<tbody>
<%
...
%>
									<tr>
										...
										<td><%= vo.getEmail() %></td>
										<td><%= vo.getBelong() %></td>
										<td width="5%"><a href="project_member_delete_quiry.jsp" type="button" style="font-size:12px">삭제</button></td>
									</tr>
<%} %>
								</tbody>
							</table>
	...
	<script language="javascript">
		function showPopup() {
			window.open("popup_member_search.jsp", "a", "width=450, height=300, left=100, top=50");
			}
	</script>
