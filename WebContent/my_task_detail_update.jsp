...
%>
	...
	<div>
	<br>
	<h3 class="text-center"><%=tdVO.getName()%> 보고 수정</h3><hr>
	<!-- 글쓰기창 -->
	<div class="active">
		<form action="task_detail_update.jsp?tdid=<%=taskDetailId%>" method="post">
			<div class="form-group">
				<input type="text" class="form-control" id="title" name ="title" placeholder="제목" value ="<%=tdVO.getName()%>">
			</div>
			<div class="form-group">
				<input type="text" class="form-control" id="progress" name = "progress" placeholder="진척도 작성" value="<%=_progress %>">
			</div>
			<div class="form-group">
				<textarea class="form-control content" id="content"rows="18" name ="work" placeholder="내용 작성..."><%=tdVO.getContent()%></textarea>
			</div>
