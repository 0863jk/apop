...
<body class="container-fluid">
	...
	boolean result = taskDAO.updateTaskInfo(_taskId, _taskName, _taskContent, _worker, _startDate, _deadline);
	%>
		...
		<div class="col-sm-10 ml-auto py-auto">
			...
			<div class = "d-flex align-items-center justify-content-center" style ="min-height: 100vh;">
				...
				<div class="text-center">
					<label class='text-center control-label'>업무내용이 수정 되었습니다.</label><p>
					<br>
					<a href='my_task_detail.jsp?taskid=<%=_taskId%>' class='btn btn-primary'>확인</a>
				</div>
				<%
					} else {
				%>
