...
<body class="container-fluid">
	...
	<%
		...
		String _progress = request.getParameter("progress");
		String _work = request.getParameter("work");
		
		boolean result = false;
		
		if(taskDetailDAO.addTaskDetail(_title, _work, _taskId)){
			if(taskDAO.updateProgress(_taskId, _progress)){
				if(timelineDAO.addHistoryAddTaskDetail(_id, _pid, _taskId)){
					result = true;	
				}
			}
		}
		...
		<div class="col-sm-10 ml-auto py-2">
			...
			<!-- 화면 -->
				...
				<div class="text-center">
					<label class='text-center control-label'>보고가 등록 되었습니다.</label><br>
				...
				%>
				<div class="text-center">
					<label class='text-center control-label'>오류가 발생 했습니다.</label><br>
					<br> <a href='project_task_assignment.jsp'
						class='btn'>확인</a>
				</div>
				<%
